...
target "linux-sage2-pytorch28-cu128-python312" {
  dockerfile = "dockerfile.builder.linux"
  target = "wheel"
  platforms = ["linux/amd64"]
  output = ["type=local,dest=./dist"]
...
target "linux-sage2-pytorch29-cu128-python312" {
  dockerfile = "dockerfile.builder.linux"
  target = "wheel"
  platforms = ["linux/amd64"]
  output = ["type=local,dest=./dist"]
...
target "test-linux-sage2-pytorch28-cu128-python312" {
  dockerfile = "dockerfile.builder.linux"
  target = "test"
  platforms = ["linux/amd64"]
  args = {
...
target "test-linux-sage2-pytorch29-cu128-python312" {
  dockerfile = "dockerfile.builder.linux"
  target = "test"
  platforms = ["linux/amd64"]
  args = {
...
group "default" {
  targets = ["linux-sage2-pytorch29-cu128-python312"]
}
...
group "sage2-all" {
  targets = [
    ...
    "linux-sage2-pytorch28-cu128-python312",
    "linux-sage2-pytorch29-cu128-python312",
  ]
}
...
group "test-all" {
  targets = [
    ...
    "test-linux-sage2-pytorch28-cu128-python312",
    "test-linux-sage2-pytorch29-cu128-python312",
  ]
}
